...
KAGENT_AGENT_URL="${KAGENT_AGENT_URL:-http://172.18.255.218:8080/}"
KAGENT_CONTROLLER_URL="${KAGENT_CONTROLLER_URL:-http://172.18.255.213:8083/api/agents}"
KAGENT_AGENT_URL_TARGET_CLUSTER_AGENT="${KAGENT_AGENT_URL_TARGET_CLUSTER_AGENT:-http://172.18.255.214:8080/}"
